/* ===============================================================
   ...
   ÄNDERUNG gegenüber der Vorversion:
   Die Bestätigungsmail an den Kunden hatte bisher kein "reply_to" —
   Antworten der Kunden wären an "formular@eldegruen-service.de"
   gegangen. Jetzt zeigt "Antworten an" korrekt auf deine echte
   Adresse eldegruen-service@gmx.de.
   ...
   Secret" im Cloudflare Pages Dashboard hinterlegt.
   =============================================================== */
        ...
        <div style="max-width:540px;margin:0 auto">
          ...
          <div style="background:#ffffff;border-radius:0 0 14px 14px;overflow:hidden;border:1px solid #e2e7de;border-top:none;box-shadow:0 8px 28px rgba(47,82,51,.08)">
            ...
            <div style="padding:36px 34px 30px;color:#222;font-size:15px;line-height:1.7">
              ...
              <p style="margin-bottom:0">Mit freundlichen Grüßen<br><strong>Ihr ELDEGRUEN-Team</strong><br><span style="color:#777;font-size:13.5px">An der Domsühler Straße 2 · 19374 Domsühl · ${EMPFAENGER}</span></p>
            </div>
    ...
    try {
      await fetch('https://api.resend.com/emails', {
        ...
        body: JSON.stringify({
          from: ABSENDER,
          to: [email],
          // NEU: Antworten des Kunden auf die Bestätigungsmail gehen jetzt
          // an deine echte Adresse statt an "formular@eldegruen-service.de".
          reply_to: EMPFAENGER,
