/* ===============================================================
   ...
   Passt zu dem Payload, das unternehmerverwaltung.html tatsächlich
   sendet (sendMailAutomatically()), und zur Antwortstruktur, die
   dort erwartet wird ({ ok: true/false }).
   ...
   In unternehmerverwaltung.html ist dazu passend bereits gesetzt:
